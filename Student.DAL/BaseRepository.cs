...
{
    /// <summary>
    /// Main class for Dapper.BaseRepository extensions
    /// </summary>
    public static partial class BaseRepository
    {
        ...
        public static async Task<T> CustomQuery<T>(string query, object param, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            var task = Task.Run(() =>
            {
                ...
                var result = connection.Query<T>(query, param, transaction, true, commandTimeout).FirstOrDefault();
        ...
        public static List<T> GetList<T>(object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            ...
            return (List<T>)connection.Query<T>(sb.ToString(), whereConditions, transaction, true, commandTimeout);
        }
        ...
        public static TKey Insert<TKey, TEntity>(TEntity entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            {
                return (TKey)typeof(BaseRepository)
        ...
        public static int Update<TEntity>(TEntity entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            if (typeof(TEntity).IsInterface) //FallBack to BaseType Generic Method: https://stackoverflow.com/questions/4101784/calling-a-generic-method-with-a-dynamic-type
            {
                return (int)typeof(BaseRepository)
        ...
        //This allows use of the DataAnnotations property in the model and have the BaseRepository engine just figure it out without a reference
    ...
    /// Custom for Dapper.BaseRepository to exclude a property from Select methods
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    ...
    /// Custom for Dapper.BaseRepository to exclude a property from Insert methods
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    ...
    /// Custom for Dapper.BaseRepository to exclude a property from Update methods
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
